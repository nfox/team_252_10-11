...
/*
 * $Id: HTTMUX-driver.h 29 2010-06-25 12:55:41Z xander $
 */

#ifndef __HTTMUX_H__
#define __HTTMUX_H__
/** \file HTTMUX-driver.h
 * \brief HiTechnic Touch Sensor Multiplexer Sensor driver
 *
 * HTTMUX-driver.h provides an API for the HiTechnic Touch Sensor Multiplexer Sensor.
 *
 * Changelog:
 * - 0.1: Initial release
 *
